...
function sendCitiesAjax() {
	//$.ajax({
	//	type: "get",
	//	url: '/Script/Address/js/queryCities.js',
	//	async: false,
	//	dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: '/Scripts/address/js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() {
	$.ajax({
		type: "get",
		url: '/Scripts/address/js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: "/Scripts/address/js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
