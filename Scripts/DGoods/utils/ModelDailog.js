define(["jquery", 'jqueryui', "../utils/SysUrl"], function ($, jqueryui, SysUrl) {
    $.fn.showext = function (options) {
        var setting = $.extend({
    ...
    $.fn.showpopu = function (options) {
        ...
        PopuWindow.prototype = {
            init: function () {
                ...
                link.type = "text/css";
                link.rel = "stylesheet";
                link.href = SysUrl.getUrl("/Content/Users/DGoods/modalDailog.css");
            ...
            setPosition: function () {
                ...
                originalh = originalh >= 200 ? 200 : originalh;
                originalw = originalw >= 380 ? 380 : originalw;

                originalh = originalh <= 145 ? 145 : originalh;
                originalw = originalw <= 300 ? 300 : originalw;
                ...
                $('.NotifyPopu').css("position", "fixed");
                var top, left;
                if (typeof $('.NotifyPopu').last().position() != 'undefined') {
                    if ($('.NotifyPopu').length > 1) {
